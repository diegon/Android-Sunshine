package com.diegonegrelli.android.sunshine.service;
...
import com.diegonegrelli.android.sunshine.R;
import com.diegonegrelli.android.sunshine.Utility;
...
public class SunshineService extends IntentService {
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Intent weatherServiceIntent = new Intent(context, SunshineService.class);
            weatherServiceIntent.putExtra(SunshineService.LOCATION_QUERY_EXTRA, Utility.getPreferredLocation(context));
